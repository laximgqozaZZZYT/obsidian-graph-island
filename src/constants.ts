...
// ===========================================================================
// ---- DiffOverlay constants ----
// Visual overlay for snapshot diffs. Prefix: DIFF_.
// ===========================================================================

/** 追加ノード／追加エッジの色（緑） — added 表現は単一の真実の源 */
...
// Decoration ring constants used by node-decorations.ts. Prefix: PF_ for
// pathfinder ring decorations, COMPARE_RING_ for compare-mode rings.
// (INDICATOR_RING_ALPHA is shared with RenderPipeline above.)
// ===========================================================================
...
// ===========================================================================
// ---- Card renderer constants ----
// Used by card-renderer.ts and semantic-zoom-renderer.ts. Prefix: CARD_,
// PLAIN_CARD, FULL_CARD_, COMPACT_CARD_.
// ===========================================================================
...
// ===========================================================================
// ---- Minimap constants ----
// Used by Minimap.ts. Prefix: MINIMAP_.
// ===========================================================================
...
// ===========================================================================
// ---- Render pipeline utils: glow + zone placement ----
// Used by render-pipeline-utils.ts.
// ===========================================================================
...
/** Zone placement text-anchor cosine threshold (positive: right-anchored) */
export const ZONE_ANCHOR_COS_POSITIVE = 0.3;
/** Zone placement text-anchor cosine threshold (negative: left-anchored) */
