 ...
 * When both forwardLinks and backlinks are enabled, all BFS-reachable nodes are added.
 * Otherwise, edges in graphEdges are scanned to keep only neighbors in the requested direction.
 */
