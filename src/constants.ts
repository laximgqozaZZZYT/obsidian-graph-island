...
// ===========================================================================
// ---- DiffOverlay (snapshot diff visualization) ----
// Moved out of src/views/DiffOverlay.ts (constants consolidation, Phase 146).
// ===========================================================================
...
// ===========================================================================
// ---- Node decorations — pathfinder / compare rings ----
// Moved out of src/views/node-decorations.ts (constants consolidation, Phase 146).
// (INDICATOR_RING_ALPHA already lives above in the RenderPipeline section.)
// ===========================================================================
...
// ===========================================================================
// ---- Card renderer (table-card / plain-card display modes) ----
// Moved out of src/views/card-renderer.ts (constants consolidation, Phase 146).
// card-renderer.ts re-exports these for API compatibility with existing callers.
// ===========================================================================
...
// ===========================================================================
// ---- Minimap ----
// Moved out of src/views/Minimap.ts (constants consolidation, Phase 146).
// ===========================================================================
...
// ===========================================================================
// ---- Render pipeline utils — glow attenuation, zone placement ----
// Moved out of src/views/render-pipeline-utils.ts (constants consolidation, Phase 146).
// render-pipeline-utils.ts re-exports the previously-exported names for API compatibility.
// ===========================================================================
...
/** Zone placement text-anchor cosine threshold (positive — anchor right) */
export const ZONE_ANCHOR_COS_POSITIVE = 0.3;
/** Zone placement text-anchor cosine threshold (negative — anchor left) */
