...
/** Pass 1: count how many non-tag nodes carry each tag. */
...
/** Pick the rarest (most specific) tag from a node's tag list. */
...
/** Collect symmetric tag↔tag pairs from inheritance/aggregation edges. */
