...
export class LabelManager {
	...
	/** Apply maxVisible cap and set visibility/alpha. Returns count of visible labels. */
	...
	/** Hide a node's primary label and any subordinate labels. */
	 ...
	 * candidates must already be priority-desc sorted.
	 */
	...
	/**
	 * Zoom-out label emphasis: boost background opacity/padding for surviving
