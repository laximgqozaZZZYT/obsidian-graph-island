...
/** Count tag occurrences across non-tag nodes — Pass 1 of buildTagMembership. */
...
/** Pick the most specific (smallest-count) tag for a node. */
...
/** Assign each non-tag node to its most specific tag — Pass 2 of buildTagMembership. */
...
/** Build tag relationship pairs from inheritance/aggregation edges — Pass 3 of buildTagMembership. */
