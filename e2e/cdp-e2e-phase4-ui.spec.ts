/**
 * Phase 4 — showArrows toggle
 * Verifies that toggling showArrows changes edge arrow rendering state.
 */
...
test.describe("Phase 4 — showArrows toggle", () => {
  test("4-1: showArrows=true is the baseline state", async () => {
