...
vi.mock("obsidian", () => ({
  App: class {},
  Modal: class { open() {} onOpen() {} onClose() {} },
  Notice: class {},
  PluginSettingTab: class {},
  Setting: class { setName() { return this; } setDesc() { return this; } addButton() { return this; } addText() { return this; } addToggle() { return this; } },
  setIcon: () => {},
}));
...
describe("HELP entries", () => {
  ...
  it("contains expected keys", () => {
    ...
    const expected = [
      "metadataFields", "colorField", "groupField",
      "enclosure", "ontology", "groupPresets",
      "clusterGroupRules", "directionalGravity", "nodeRules",
    ];
