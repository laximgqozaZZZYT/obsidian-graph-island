...
function renderCategorySection(
  body: HTMLElement, colorMap: Map<string, string>,
  categoryCounts: Map<string, number>, legendColorMode: string,
  panel: LegendPanel, host: LegendHost,
): void {
...
function renderHeatmapSection(
  body: HTMLElement, legendColorMode: string, host: LegendHost,
): void {
...
function renderFieldSection(
  body: HTMLElement, colorMap: Map<string, string>,
  legendColorMode: string, panel: LegendPanel,
): void {
...
function renderEdgeRelationSection(
  body: HTMLElement, relColors: Map<string, string>,
  panel: LegendPanel, host: LegendHost,
): void {
