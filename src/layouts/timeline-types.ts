...
/** 単一ノードの配置結果 */
export interfaceTimelinePlacement {
	nodeId: string;
	/** X 位置 (時間軸) */
	x: number;
	/** Y 位置 (レーン軸) */
