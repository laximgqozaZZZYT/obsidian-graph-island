...
// ===========================================================================
// ---- Render pipeline utilities (render-pipeline-utils.ts) ----
// Glow attenuation, zone placement anchor thresholds, label Y offset.
// ===========================================================================
...
/** Zone placement text-anchor cosine threshold (positive side) */
export const ZONE_ANCHOR_COS_POSITIVE = 0.3;
/** Zone placement text-anchor cosine threshold (negative side) */
...
// ===========================================================================
// ---- Node-decoration extras (node-decorations.ts) ----
// Pathfinder marker geometry and compare-mode ring styling.
// (INDICATOR_RING_ALPHA already defined in the Render pipeline section above.)
// ===========================================================================
...
/** Compare-selection ring stroke width */
export const COMPARE_RING_LINE_WIDTH = 2.5;
/** Compare-selection ring radius padding */
export const COMPARE_RING_RADIUS_PAD = 8;
/** Compare-selection ring color (magenta) */
export const COMPARE_RING_COLOR = 0xe879f9;
/** Compare-selection ring alpha */
export const COMPARE_RING_ALPHA = 0.85;
/** Compare-selection ring dashed-segment count */
export const COMPARE_RING_SEGMENTS = 8;
/** Compare-selection ring gap fraction within each segment */
export const COMPARE_RING_GAP = 0.3;

// ===========================================================================
// ---- Card mode rendering (card-renderer.ts) ----
// Font families, sizes, and icon ratios for table-card / plain-card modes.
// ===========================================================================
...
/** Card icon shape proportions (folded-corner notepad icon) */
...
/** Plain-card layout constants (no field rows — title + optional body) */
...
// ===========================================================================
// ---- Minimap (Minimap.ts) ----
// Overlay dimensions, density-based dot scaling, viewport rectangle styling.
// ===========================================================================
...
// ===========================================================================
// ---- Diff overlay (DiffOverlay.ts) ----
// Snapshot diff overlay colors, ring/ghost geometry, status bar styling.
// ===========================================================================

/** Added-node ring color (green) */
export const DIFF_ADDED_COLOR = "#22c55e";
/** Removed-node color (gray) */
export const DIFF_REMOVED_COLOR = "#9ca3af";
/** Removed-node fill alpha */
export const DIFF_REMOVED_ALPHA = 0.3;
/** Metadata-changed-node ring color (yellow) */
export const DIFF_CHANGED_COLOR = "#eab308";
/** Added-edge color (green) */
export const DIFF_ADDED_EDGE_COLOR = "#22c55e";
/** Removed-edge color (red) */
export const DIFF_REMOVED_EDGE_COLOR = "#ef4444";
/** Ring stroke width (px) */
export const DIFF_RING_LINE_WIDTH = 2;
/** Ghost-node radius (px) */
export const DIFF_GHOST_RADIUS = 6;
/** Ghost-node grid spacing (px) */
export const DIFF_GHOST_SPACING = 24;
/** Ghost-node label font size (px) */
export const DIFF_GHOST_FONT_SIZE = 9;
/** Ghost-area margin from viewport edge (px) */
export const DIFF_GHOST_MARGIN = 40;
/** Status-bar background color */
export const DIFF_STATUS_BG = "rgba(0, 0, 0, 0.6)";
/** Status-bar text color */
export const DIFF_STATUS_TEXT_COLOR = "#ffffff";
/** Status-bar font size (px) */
export const DIFF_STATUS_FONT_SIZE = 12;
/** Status-bar padding (px) */
export const DIFF_STATUS_PADDING = 8;
