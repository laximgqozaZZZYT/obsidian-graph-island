 ...
 * preparation. Intended to be called from GraphViewContainer; this file only
 * provides the pure building blocks. The underlying pure converter
 * `exportGraphSVG` lives in `src/utils/graph-helpers.ts` and is imported
 * directly by callers — not re-exported here.
 */
