/**
 * LOD (Level of Detail) and culling pure functions extracted from RenderPipeline.
 * No DOM/Canvas dependency for the numeric helpers; the LOD-tier renderers take
 * a CanvasGraphics + PixiNode[] and emit draw calls but hold no `this` state.
 */
 ...
 * Used by the glow pass to find the p90 degree without a full sort.
 */
 ...
 *  (collapsed groups) still render as dots since they already represent
 *  aggregated clusters. */
