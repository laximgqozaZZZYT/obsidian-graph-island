...
import type { SortKey, OntologyRule, OntologyRelation, ClusterGroupRule, ClusterGroupBy, GraphViewsSettings, NodeRule, GroupRule, SortRule, SortOrder } from "../types";
...
export function buildDualRangeSlider(container: HTMLElement, label: string, initialMin: number, initialMax: number, onChange: (min: number, max: number) => void, description?: string) {
...
export function addSlider(container: HTMLElement, label: string, min: number, max: number, step: number, initial: number, onChange: (v: number) => void, description?: string): HTMLElement {
...
export function addToggle(container: HTMLElement, label: string, initial: boolean, onChange: (v: boolean) => void, description?: string): HTMLElement {
...
export function addTextInput(container: HTMLElement, label: string, initial: string, placeholder: string, onChange: (v: string) => void) {
...
export function renderGroupByRules(
  container: HTMLElement,
  panel: PanelState,
  ctx: PanelContext,
  cb: PanelCallbacks,
...
export function setCachedFieldSuggestions(suggestions: string[]) { _cachedFieldSuggestions = suggestions; }
 ...
 */
export function parseActiveToken(value: string, cursorPos: number): { prefix: string; partial: string; tokenStart: number } | null {
...
export function _setupQueryHintListeners(input: HTMLInputElement, ctx: {
  show: () => void;
  hide: () => void;
  rebuildHint: () => void;
...
export function _setupSearchJumpListeners(input: HTMLInputElement, ctx: {
  rebuild: () => void;
  dismiss: () => void;
...
export function addSelect(container: HTMLElement, label: string, options: { value: string; label: string }[], initial: string, onChange: (v: string) => void, description?: string) {
...
export function renderSortRuleList(
  container: HTMLElement,
  panel: PanelState,
  cb: PanelCallbacks,
) {
