...
export function rulesToOntologyFields(rules: OntologyRule[], o: OntologyConfig): void {
	...
	for (const r of rules) {
		...
		switch (r.relation) {
			case "is-a":
				o.inheritanceFields.push(...fwd);
				o.reverseInheritanceFields.push(...rev);
				break;
			case "has-a":
				o.aggregationFields.push(...fwd);
				o.reverseAggregationFields.push(...rev);
				break;
			case "is-from":
				o.sequenceFields.push(...fwd);
				o.reverseSequenceFields.push(...rev);
				break;
			case "is-alike":
				o.similarFields.push(...fwd);
				break;
			case "sibling":
				o.siblingFields.push(...fwd);
				break;
		}
	}
}
...
export const DEFAULT_RENDER_THRESHOLDS: Required<RenderThresholds> = {
	...
	labelOverlapMargin: 20,
	labelDensityMinScreenDist: 90,
...
export function mergeRenderThresholds(user?: Partial<RenderThresholds>): Required<RenderThresholds> {
