...
describe("buildTimelineEntries", () => {
	...
	it("preserves snapshot names including [auto] prefix", () => {
		const entries = buildTimelineEntries([makeSnap("[auto] 2026-01-01 12:00", "2026-01-01T12:00", 100, 200)]);
	...
	it("does not mutate input array", () => {
		const input = [makeSnap("b", "2026-02-01T00:00", 200, 300), makeSnap("a", "2026-01-01T00:00", 100, 200)];
