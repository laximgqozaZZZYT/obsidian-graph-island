...
// Constants moved to ../constants. Re-exported here so existing consumers
// (RenderPipeline) and unit tests that import from this module keep working.
export {
	GLOW_ATTENUATE_THRESHOLD,
	GLOW_ATTENUATE_RANGE,
	GLOW_RADIUS_ATTENUATE_FACTOR,
...
// ---------------------------------------------------------------------------
// Glow attenuation — constants in ../constants
// ---------------------------------------------------------------------------
...
// Zone placement / label-Y-offset constants moved to ../constants.
