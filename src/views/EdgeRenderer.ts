...
// ---------------------------------------------------------------------------
// Group BBox / perimeter routing, junction grid, and angle utilities are
// now in ./edge-renderer/cable-tray. Re-exported here for backward
// compatibility with tests and other callers.
// ---------------------------------------------------------------------------
export {
	computeGraphCenter,
	computeGroupBBox,
	...
	angleDist,
	shortestAngleDelta,
} from "./edge-renderer/cable-tray";
export type { BBoxFace, GroupBBox, JunctionGrid } from "./edge-renderer/cable-tray";
import type { GroupBBox } from "./edge-renderer/cable-tray";
