...
// ---------------------------------------------------------------------------
// Edge style resolution — extracted to ./edge-style-resolver.ts
// Re-exported here so existing tests and callers keep working.
// ---------------------------------------------------------------------------
import { resolveEdgeStyle, type EdgeStyle } from "./edge-style-resolver";
export { resolveEdgeStyle, type EdgeStyle };
