...
export class GraphViewContainer extends ItemView implements InteractionHost, RenderHost, LayoutHost {
	...
	private _setupForceLayout(
		...
		// Seed initial positions: fade-in spiral / saved / random / pinned.
		// See seedNodePositions() docs for branch order.
		// `fade` is also referenced below to hide fresh sprites for the fade-in tween.
