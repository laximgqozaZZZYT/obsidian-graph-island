...
元のissue対象のworktree (`auto-20260416-020001-4058240`) は既に削除済みです。残っているのは別のworktree (`auto-20260416-035501-700670`) で、こちらは未コミット変更なし（クリーン状態）です。

issueの状況が変わっているため、タスクを現状に合わせて分解します。
