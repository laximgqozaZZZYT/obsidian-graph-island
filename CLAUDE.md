...
|------|-------|-------------|----------------------|
| `src/views/GraphViewContainer.ts` | 8616 | 8616 | 1 — extract: snapshot, export, filter orchestration |
...
| `src/views/RenderPipeline.ts` | 2127 | 2321 | 4 — extract: LOD logic, culling logic |
