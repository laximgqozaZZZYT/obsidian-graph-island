...
const helpEn: TranslationMap = {
  ...
  "help.surprise": "Random pair discovery at timed intervals.\nSet to 0 to disable.",
  "help.cableBundle": "Edge bundling routes edges through cluster centroids.\n  auto: enable when clusters exist\n  always/never: force on/off",
...
const helpJa: TranslationMap = {
  ...
  "help.surprise": "ランダムペア発見をタイマーで実行。\n0に設定すると無効。",
  "help.cableBundle": "エッジ束ね: エッジをクラスタ重心経由でルーティング。\n  auto: クラスタがある時のみ有効\n  always/never: 強制オン/オフ",
  "help.roadNetwork": "ロードネットワーク: ジャンクション形式のエッジ表示。\nクラスタ間をロードレーンとして描画。",
  "help.displayOther": "ミニマップ、凡例、画面外ノードバッジ、\nグラフ統計パネル。",
  "help.renderThresholds": "レンダリング性能の微調整:\n  LOD閾値、ラベル制限、衝突パディング、\n  グラデーション/グロー対象ノード数。",
