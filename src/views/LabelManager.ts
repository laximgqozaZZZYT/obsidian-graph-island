...
export class LabelManager {
	...
	private _applyDiversityAndCap(
		...
		// Map-style labeling on desktop: no cap (0). Overlap culling handles density.
	...
	/** Walk priority-sorted candidates, toggling visibility under maxVisible cap. Returns visible count. */
	 ...
	 *  labels visible so labelReadability stays >= 50. Mutates candidates' visibility. */
	...
	/** Boost background opacity/padding for surviving labels at low zoom so important
	 *  nodes stand out. No-op when zoom >= 0.5. */
