...
import type { GraphEdge, EdgeCardinalityMode, CardinalityRule, CardinalityRenderConfig } from "../types";
...
} from "./edge-rendering/edge-markers";
...
import { drawIntraGroupCables, drawTrunks } from "./edge-rendering/cable-tray-renderer";
...
// Cable-tray drawing functions (drawIntraGroupCables, drawTrunks, drawSmoothPath
// and their internal helpers) moved to ./edge-rendering/cable-tray-renderer.ts.
// cableFadeByDegree, cableWeightThickness moved to CableTrayRenderer.ts.

// Intra-group cable cache state lives in EdgeRenderCache below.
...
// Marker / arrow / cardinality drawing helpers extracted to edge-rendering/edge-markers.ts
