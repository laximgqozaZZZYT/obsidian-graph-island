...
describe("createProgram", () => {
  ...
  it("throws with info log on link failure", () => {
    ...
    expect(() => createProgram(gl, 1 as unknown as WebGLShader, 2 as unknown as WebGLShader))
      .toThrow("Program link error: mock link error log");
