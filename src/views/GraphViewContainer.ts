...
export class GraphViewContainer extends ItemView implements InteractionHost, RenderHost, LayoutHost {
	...
	private _setupForceLayout(
		...
		// render, before seedNodePositions consumes them. Used to pick a lower
		...
		// Seed initial positions: fade-in spiral / saved / scatter / pinned.
		// Pure helper — keeps _setupForceLayout under the complexity ceiling.
		seedNodePositions(gd.nodes, {
			cx,
			cy,
			W,
			H,
