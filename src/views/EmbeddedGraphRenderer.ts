...
export function renderEmbeddedGraph(el: HTMLElement, source: string, app: App, settings: GraphViewsSettings): void {
...
function doRender(container: HTMLElement, config: EmbedConfig, app: App, settings: GraphViewsSettings): void {
	const height = config.height ?? 300;
