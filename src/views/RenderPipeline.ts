...
// LOD/culling pure functions extracted to ./render-pipeline/lod-culling.ts.
// (Render constants live in constants.ts.)
import { renderExtremeZoom, renderMidZoom } from "./render-pipeline/lod-culling";
import {
	screenToWorld,
	...
	quickSelect,
} from "./render-pipeline/lod-culling";
export {
	screenToWorld,
	computeZoomFadeAlpha,
	computeLodLevel,
...
// quickSelect (Hoare's selection) lives in ./render-pipeline/lod-culling.ts.
// ---------------------------------------------------------------------------
...
export class RenderPipeline {
	...
	/** Extreme/mid zoom LOD-tier rendering lives in ./render-pipeline/lod-culling.ts. */
