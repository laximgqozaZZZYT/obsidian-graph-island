...
const en: TranslationMap = {
	...
	"section.coordinateControls": "Coordinate Axes",
	"section.timelineControls": "Timeline",
	"section.forceParameters": "Force Parameters",
	...
	"filter.minDegree": "Min Degree",
	"filter.maxDegree": "Max Degree",
	...
	"display.nodeColor.field": "By Field",
	"desc.nodeColorMode": "How to color nodes: default, category, heatmap, community, or custom field",
	...
	"display.hoverShowTitle": "Hover: Title",
	"display.hoverShowMeta": "Hover: Metadata",
	"display.hoverShowBody": "Hover: Body Preview",
	...
	"section.hoverBehavior": "Hover Behavior",
	"hover.forwardLinks": "Forward Links",
	"hover.backlinks": "Backlinks",
	"hover.sharedTags": "Shared Tags",
	"hover.sameFolder": "Same Folder",
	...
	"display.inlineRelation": "Inline Relation (@relation)",
	...
	"display.edgeOpacity": "Edge Opacity",
	"display.edgeLabelFontSize": "Edge Label Size",
	"display.maxHoverLabels": "Max Hover Labels",
	"display.edgeMinZoom": "Edge Min Zoom",
	"desc.edgeMinZoom": "Minimum zoom level to show edges (0 = always visible)",
	"display.edgeZoomFadeThreshold": "Edge Zoom Fade",
	"desc.edgeZoomFadeThreshold": "Zoom level below which edges thin and fade (default 0.5)",
	"display.edgeLabelZoomHide": "Label Hide Zoom",
	"desc.edgeLabelZoomHide": "Zoom level below which edge labels are hidden (default 0.15)",
	"display.edgeLabelZoomFade": "Label Fade Zoom",
	"desc.edgeLabelZoomFade": "Zoom level below which edge labels fade in (default 0.3)",
	"display.edgeFadeMinAlpha": "Edge Fade Floor",
	"desc.edgeFadeMinAlpha": "Minimum edge alpha at extreme zoom-out (default 0.1)",
	"filter.includeTagsInData": "Include Tags in Data",
	"desc.includeTagsInData": "Include tag nodes and has-tag edges in graph data",
	"filter.autoFit": "Auto-fit on Filter",
	"display.labelDensity": "Label Density",
	"desc.labelDensity": "Controls how many labels are shown when zoomed out",
	"display.zoomSensitivity": "Zoom Sensitivity",
	"desc.zoomSensitivity": "Scroll wheel zoom speed (0.3=gentle, 1.0=normal, 2.0=fast)",
	"display.labelMode": "Label Mode",
	"display.cardPreset": "Card Preset",
	"display.cardPresetCustom": "Custom",
	"display.cardPresetCompact": "Compact",
	"display.cardPresetDetailed": "Detailed",
	"display.cardPresetFull": "Full",
	"display.customPalette": "Custom Palette",
	"display.nodeColorField": "Color Field",
	"nodes.filterPlaceholder": "Filter nodes...",
	"nodes.forwardLink": "Forward Links",
	"nodes.backlink": "Backlinks",
	...
	"render.labelCullCooldown": "Label Cull Cooldown",
	"render.labelCullCooldownDesc": "Frames to skip between label recalculations (lower = faster zoom response)",
	...
	"display.cardFieldFormat": "Field Format",
	"display.cardBodyLines": "Body Lines",
	...
	"display.cardBodyFontSize": "Body Font Size",
	"display.cardBgOpacity": "Card Opacity",
	"display.enclosureFillOpacity": "Enclosure Fill",
	"display.enclosureStrokeWidth": "Enclosure Stroke",
	"display.enclosureLabelPos": "Label Position",
	"display.enclosureLabelPos.top": "Top",
	"display.enclosureLabelPos.center": "Center",
	"display.enclosureLabelPos.bottom": "Bottom",
	"display.labelMaxChars": "Label Max Chars",
	...
	"a11y.nodes": "nodes",
	"a11y.edges": "edges",
	"a11y.focusCleared": "Focus cleared",
	...
	"toolbar.lasso": "Lasso Select",
	"context.openSubgraph": "Open as subgraph",
	"context.openSubgraphNewTab": "Open in new tab",
	"toolbar.backToFullGraph": "Back to full graph",
	"toolbar.exportPng": "Export as PNG",
	"toolbar.exportSvg": "Export as SVG",
	...
	"snapshot.compareTip": "{name}: {nodeCount}n, {edgeCount}e — Shift+click to compare two",
	...
	"desc.enclosureMinRatio": "Min fraction of nodes a tag must cover to form an enclosure",
	...
	"desc.inlineRelation": "Show edges from inline relation annotations ([[target]@relation])",
	...
	"settingsTab.description":
		"Each setting can be edited directly from the graph view panel. Here you can export/import settings as JSON.",
	...
	"settingsTab.jsonPathDesc":
		"JSON file path within the vault (e.g., settings/graph-island.json). Used as export target.",
	...
	// --- Hardcoded string cleanup (Issue 008) ---
	"stats.edgeWarn": "\u26a0 {count} edges \u2014 consider enabling edge fade or reducing hops",
	"stats.copyBtn": "MD",
	"stats.copyBtnTitle": "Copy as Markdown",
	"stats.qualityDashboard": "Quality Dashboard",
	"stats.relationMatrix": "Relation Matrix",
	"stats.overlapTip": "High overlap — try increasing node spacing or enabling auto-optimize",
	"stats.degreeTip": "degree {degree}{plus}: {count} nodes — click to filter",
	"density.moreHidden": "+{count} more hidden",
	"hover.loading": "Loading\u2026",
	"hover.couldNotRead": "(could not read)",
	"oob.offScreen": "{count} off-screen",
	"detail.tagBadge": "tag",
	"detail.linkBtn": "Link",
	"embed.noNodes": "No nodes found",
	"export.csvBtn": "CSV",
	"export.pngDone": "Graph exported as PNG",
	"export.graphDone": "Graph exported: {nodes} nodes, {edges} edges",
	"export.csvDone": "CSV exported: {nodes} nodes, {edges} edges",
	"export.mermaidDone": "Mermaid diagram copied to clipboard ({nodes} nodes)",
	"export.statsCopied": "Stats copied as Markdown",
	"help.title": "Graph Island \u2014 Keyboard Shortcuts",
	"help.sectionNavigation": "Navigation",
	"help.sectionSelection": "Selection & Comparison",
	"help.sectionDisplay": "Display",
	"help.sectionActions": "Actions",
	"help.sectionModes": "Thinking Modes",
	"help.nav.tabCycle": "Cycle focus through nodes",
	"help.nav.arrowKeys": "Pan graph / Navigate neighbors (when node focused)",
	"help.nav.zoomInOut": "Zoom in / out",
	"help.nav.zoomDigits": "Zoom: 0=100%, 1=10%, ..., 9=90%",
	"help.nav.focusZoom": "Focus-zoom to highlighted node",
	"help.nav.fitView": "Fit graph to view",
	"help.nav.scroll": "Zoom in/out",
	"help.sel.clickHover": "Focus node + details",
	"help.sel.shiftClick": "Multi-select toggle",
	"help.sel.ctrlA": "Select all visible nodes",
	"help.sel.ctrlD": "Deselect all",
	"help.sel.ctrlE": "Copy graph to clipboard (PNG)",
	"help.sel.ctrlClick": "Add to compare",
	"help.sel.pathStart": "Set pathfinder start",
	"help.sel.pathEnd": "Set pathfinder end",
	"help.sel.enter": "Open focused node's file",
	"help.sel.dblClick": "Open file / Inline edit",
	"help.disp.panel": "Toggle settings panel",
	"help.disp.legend": "Toggle legend",
	"help.disp.minimap": "Toggle minimap",
	"help.disp.grid": "Toggle dot grid",
	"help.disp.hops": "Decrease / increase hover hops",
	"help.disp.tabSwitch": "Switch panel tab",
	"help.act.search": "Focus search",
	"help.act.copyPng": "Copy graph as PNG",
	"help.act.contextMenu": "Context menu",
	"help.act.dragNode": "Move + pin position",
	"help.act.dragCanvas": "Pan view",
	"help.act.escape": "Close overlay / clear focus",
	"help.act.helpToggle": "Toggle this help",
	"help.mode.explore": "Active file centered, gap detection, suggestions",
	"help.mode.analyze": "Full structure: stats, bridges, entropy, communities",
...
const ja: TranslationMap = {
	...
	"section.coordinateControls": "座標軸",
	"section.timelineControls": "タイムライン",
	"section.forceParameters": "力学パラメータ",
	...
	"filter.minDegree": "最小次数",
	"filter.maxDegree": "最大次数",
	...
	"display.nodeColor.field": "フィールド別",
	"desc.nodeColorMode": "ノードの色分け方式: デフォルト、カテゴリ、ヒートマップ、コミュニティ、フィールド別",
	...
	"section.hoverBehavior": "ホバー時の動作",
	"hover.forwardLinks": "リンク先",
	"hover.backlinks": "バックリンク先",
	"hover.sharedTags": "同じタグのノード",
	"hover.sameFolder": "同じフォルダのノード",
	"display.hoverShowTitle": "ホバー: タイトル",
	"display.hoverShowMeta": "ホバー: メタデータ",
	"display.hoverShowBody": "ホバー: 本文プレビュー",
	...
	"display.inlineRelation": "インラインリレーション (@relation)",
	...
	"display.edgeOpacity": "エッジ透明度",
	"display.edgeLabelFontSize": "エッジラベルサイズ",
	"display.maxHoverLabels": "ホバーラベル最大数",
	"display.edgeMinZoom": "エッジ最小ズーム",
	"desc.edgeMinZoom": "エッジを表示する最小ズームレベル（0＝常に表示）",
	"display.edgeZoomFadeThreshold": "エッジズームフェード",
	"desc.edgeZoomFadeThreshold": "このズームレベル以下でエッジを徐々に細く薄くする（デフォルト0.5）",
	"display.edgeLabelZoomHide": "ラベル非表示ズーム",
	"desc.edgeLabelZoomHide": "このズーム以下でエッジラベルを非表示にする（デフォルト0.15）",
	"display.edgeLabelZoomFade": "ラベルフェードズーム",
	"desc.edgeLabelZoomFade": "このズーム以下でエッジラベルをフェードイン（デフォルト0.3）",
	"display.edgeFadeMinAlpha": "エッジフェード下限",
	"desc.edgeFadeMinAlpha": "極端なズームアウト時のエッジ最小透明度（デフォルト0.1）",
	"filter.includeTagsInData": "タグデータを含める",
	"desc.includeTagsInData": "グラフデータにタグノードとhas-tagエッジを含める",
	"filter.autoFit": "フィルタ時に自動フィット",
	"display.labelDensity": "ラベル密度",
	"desc.labelDensity": "ズームアウト時のラベル表示量を制御",
	"display.zoomSensitivity": "ズーム感度",
	"desc.zoomSensitivity": "スクロール速度 (0.3=ゆっくり, 1.0=標準, 2.0=速い)",
	"display.labelMode": "ラベルモード",
	"display.cardPreset": "カードプリセット",
	"display.cardPresetCustom": "カスタム",
	"display.cardPresetCompact": "コンパクト",
	"display.cardPresetDetailed": "詳細",
	"display.cardPresetFull": "フル",
	"display.customPalette": "カスタムパレット",
	"display.nodeColorField": "カラーフィールド",
	"nodes.filterPlaceholder": "ノードを検索...",
	"nodes.forwardLink": "前方リンク",
	"nodes.backlink": "バックリンク",
	"nodes.hovered": "ホバー中",
	"search.history": "履歴",
	...
	"render.labelCullCooldown": "ラベルカルクールダウン",
	"render.labelCullCooldownDesc": "ラベル再計算をスキップするフレーム数（低い=ズーム応答が速い）",
	...
	"display.cardFieldFormat": "フィールド形式",
	"display.cardBodyLines": "本文行数",
	"display.cardContentScale": "本文量カードサイズ",
	"desc.cardContentScale": "本文の文字数に比例してカードサイズを調整（対数スケール）",
	"display.cardBodyFontSize": "本文フォントサイズ",
	"display.cardBgOpacity": "カード透明度",
	"display.enclosureFillOpacity": "囲い塗りつぶし",
	"display.enclosureStrokeWidth": "囲い線幅",
	"display.enclosureLabelPos": "ラベル位置",
	"display.enclosureLabelPos.top": "上",
	"display.enclosureLabelPos.center": "中央",
	"display.enclosureLabelPos.bottom": "下",
	"display.labelMaxChars": "ラベル最大文字数",
	...
	"toolbar.lasso": "投げ縄選択",
	"context.openSubgraph": "サブグラフとして表示",
	"context.openSubgraphNewTab": "新タブで開く",
	"toolbar.backToFullGraph": "全体に戻る",
	"toolbar.exportPng": "PNGで書き出し",
	"toolbar.exportSvg": "SVGで書き出し",
	"toast.svgExported": "SVGを書き出しました",
	...
	"snapshot.compareTip": "{name}: {nodeCount}n, {edgeCount}e — Shift+クリックで2つを比較",
	"nav.back": "戻る",
	"nav.forward": "進む",
	...
	"desc.enclosureMinRatio": "タグが包絡線を形成するために必要なノードの最小割合",
	...
	"desc.inlineRelation": "インラインリレーション注釈（[[target]@relation]）のエッジを表示",
	...
	// --- Settings Tab ---
	"settingsTab.description":
		"各設定項目はグラフビューのパネルから直接編集できます。ここでは設定の JSON エクスポート / インポートを行えます。",
	...
	"settingsTab.jsonPathDesc":
		"Vault 内の JSON ファイルパス（例: settings/graph-island.json）。エクスポート先に使用します。",
	...
	// --- ハードコード文字列クリーンアップ (Issue 008) ---
	"stats.edgeWarn": "\u26a0 {count} エッジ \u2014 エッジフェードの有効化またはホップ数の削減をお勧めします",
	"stats.copyBtn": "MD",
	"stats.copyBtnTitle": "Markdownでコピー",
	"stats.qualityDashboard": "品質ダッシュボード",
	"stats.relationMatrix": "関係マトリクス",
	"stats.overlapTip": "重なりが多い — ノード間隔を広げるか自動最適化を有効にしてください",
	"stats.degreeTip": "次数 {degree}{plus}: {count} ノード — クリックでフィルタ",
	"density.moreHidden": "+{count} 件非表示",
	"hover.loading": "読み込み中\u2026",
	"hover.couldNotRead": "（読み取り不可）",
	"oob.offScreen": "{count} 件画面外",
	"detail.tagBadge": "タグ",
	"detail.linkBtn": "リンク",
	"embed.noNodes": "ノードが見つかりません",
	"export.csvBtn": "CSV",
	"export.pngDone": "グラフをPNGでエクスポートしました",
	"export.graphDone": "グラフをエクスポート: {nodes}ノード, {edges}エッジ",
	"export.csvDone": "CSVをエクスポート: {nodes}ノード, {edges}エッジ",
	"export.mermaidDone": "Mermaidダイアグラムをクリップボードにコピー ({nodes}ノード)",
	"export.statsCopied": "統計をMarkdownでコピーしました",
	"help.title": "Graph Island \u2014 キーボードショートカット",
	"help.sectionNavigation": "ナビゲーション",
	"help.sectionSelection": "選択 & 比較",
	"help.sectionDisplay": "表示",
	"help.sectionActions": "操作",
	"help.sectionModes": "思考モード",
	"help.nav.tabCycle": "ノード間をフォーカス移動",
	"help.nav.arrowKeys": "グラフをパン / 隣接ノードへ移動（ノードフォーカス時）",
	"help.nav.zoomInOut": "ズームイン / アウト",
	"help.nav.zoomDigits": "ズーム: 0=100%, 1=10%, ..., 9=90%",
	"help.nav.focusZoom": "ハイライトノードにズーム",
	"help.nav.fitView": "グラフを全体表示",
	"help.nav.scroll": "ズームイン/アウト",
	"help.sel.clickHover": "ノードをフォーカス + 詳細表示",
	"help.sel.shiftClick": "マルチ選択の切り替え",
	"help.sel.ctrlA": "表示中の全ノードを選択",
	"help.sel.ctrlD": "すべて選択解除",
	"help.sel.ctrlE": "グラフをクリップボードにコピー（PNG）",
	"help.sel.ctrlClick": "比較に追加",
	"help.sel.pathStart": "パスファインダー始点を設定",
	"help.sel.pathEnd": "パスファインダー終点を設定",
	"help.sel.enter": "フォーカスノードのファイルを開く",
	"help.sel.dblClick": "ファイルを開く / インライン編集",
	"help.disp.panel": "設定パネルの表示/非表示",
	"help.disp.legend": "凡例の表示/非表示",
	"help.disp.minimap": "ミニマップの表示/非表示",
	"help.disp.grid": "ドットグリッドの表示/非表示",
	"help.disp.hops": "ホバーホップ数の増減",
	"help.disp.tabSwitch": "パネルタブ切り替え",
	"help.act.search": "検索にフォーカス",
	"help.act.copyPng": "グラフをPNGでコピー",
	"help.act.contextMenu": "コンテキストメニュー",
	"help.act.dragNode": "移動 + 位置固定",
	"help.act.dragCanvas": "表示範囲をパン",
	"help.act.escape": "オーバーレイを閉じる / フォーカス解除",
	"help.act.helpToggle": "このヘルプの表示/非表示",
	"help.mode.explore": "アクティブファイル中心、ギャップ検出、サジェスト",
	"help.mode.analyze": "全構造分析: 統計、ブリッジ、エントロピー、コミュニティ",
...
const helpEn: TranslationMap = {
	...
	"help.cableBundle":
		"Edge bundling routes edges through cluster centroids.\n  auto: enable when clusters exist\n  always/never: force on/off",
	"help.roadNetwork": "Road network overlay for junction-based routing.\nShows edges as road lanes between clusters.",
	"help.displayOther": "Minimap, legend, out-of-bounds indicator,\ngraph statistics panel.",
	"help.renderThresholds":
		"Fine-tune rendering performance:\n  LOD thresholds, label limits, collision padding,\n  gradient/glow node counts.",
	"help.relationColors": "Customize colors for each edge relation type.\nClick the color swatch to change.",
	"help.displayGrouping": "Group nodes by frontmatter field or tag.\nChoose arrangement pattern and spacing.",
	"help.exprReference":
...
const helpJa: TranslationMap = {
	...
	"help.advanced":
		"プレゼンテーションモード、フォーカスコーン、\n  ビジュアルリンクエディタ(Alt+ドラッグ)、関係ドロワー。",
	"help.cableBundle":
		"エッジ束ね: エッジをクラスタ重心経由でルーティング。\n  auto: クラスタがある時のみ有効\n  always/never: 強制オン/オフ",
	"help.roadNetwork": "ロードネットワーク: ジャンクション形式のエッジ表示。\nクラスタ間をロードレーンとして描画。",
	"help.displayOther": "ミニマップ、凡例、画面外ノードバッジ、\nグラフ統計パネル。",
	"help.renderThresholds":
		"レンダリング性能の微調整:\n  LOD閾値、ラベル制限、衝突パディング、\n  グラデーション/グロー対象ノード数。",
	"help.relationColors": "各エッジ関係タイプのカスタム色。\nカラースウォッチをクリックして変更。",
	"help.displayGrouping": "フロントマターフィールドやタグでノードをグループ化。\n配置パターンと間隔を選択。",
	"help.exprReference":
