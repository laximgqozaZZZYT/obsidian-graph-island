...
status: pending
source: decomposed
parent: 1032-1012-752-712-639-626-subtask-issue-pending-do
depends: none
summary: 752-712-639-626-subtask issue を pending→done に git mv + status:done 化 + 1コミット
---

## Description (subtask of 1032-1012-752-712-639-626-subtask-issue-pending-do)
...
注: 本 issue は `git mv` + frontmatter 1 行書換 + 単一コミットという不可分な原子操作。5 手順はすべて 1 コミットに収める必要があるため、これ以上の分解は逆にアトミック性を壊すので 1 SUBTASK のままとする。
